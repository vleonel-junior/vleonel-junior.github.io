...
Avant de plonger dans les algorithmes de machine learning, nous avons besoin d'une base solide en statistiques descriptives. Ce sont les outils qui nous permettent de résumer et de comprendre les données en un coup d'œil.

Pensez à vos notes d'examen du semestre dernier. Au lieu de mémoriser chaque note individuellement, ne serait-il pas plus simple de connaître simplement votre moyenne ? C'est cela, les statistiques en action : prendre un ensemble de nombres et les condenser en une information utile.
...
![Distribution des salaires](/Portfolio-main/images/descriptive-statistics/distribution-salaires.png)
